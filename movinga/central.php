...
<p style="color: #333;">
 <p>
  <p style="font-size: 13px; color: #ff5722; line-height: 20px; font-weight: bold; " id="Uname"></p>
  <p style="font-size: 12px; color: #666; line-height: 24px; font-weight: bold; text-transform: uppercase;" id="jobtitle1"></p>
 </p>
 <p style="font-size: 10px; line-height: 22px;">
  <p class="signature">
   <a href="" id="emailid1" class="signature" style="color: #333; cursor: pointer; text-decoration: underline;"></a>
  </p>
  <p class="signature">
   <a href="" id="mobileno1" class="signature" style="color: #333; cursor: pointer; text-decoration: underline;"></a>
  </p>
  <p class="signature">
   <a href="http://www.movinga.de/" class="signature" style="color: #333; cursor: pointer; text-decoration: underline;">www.movinga.de</a>
  </p>
  <img class="signature" style="width: 100%; max-width: 100%; vertical-align: middle; display: inline-block; border: 0;" src="https://download.movinga.com/email-signature/line.png">
 </p>
 <div class="signature" style="line-height: 20px;"><a href="https://www.movinga.com"><img class="signature" src="https://download.movinga.com/email-signature/movinga-36.png" width="120"></a><a href="https://www.pinterest.com/movingade"><img class="signature" style="margin-left: 6px;width: 24px;" src="https://download.movinga.com/email-signature/pinterest-36.png"></a><a href="https://www.facebook.com/movinga.de"><img class="signature" style="margin-left: 6px;width: 24px;"  src="https://download.movinga.com/email-signature/facebook-36.png"></a><a href="https://www.instagram.com/movinga/"><img style="margin-left: 6px;width: 24px;" src="https://download.movinga.com/email-signature/instagram-36.png"></a><a href="https://twitter.com/Movinga" class="w-inline-block"><img style="margin-left: 6px;width: 24px;" src="https://download.movinga.com/email-signature/twitter-36.png"></a><a href="https://www.linkedin.com/company/movinga-gmbh" class="w-inline-block"><img style="margin-left: 6px;width: 24px;" src="https://download.movinga.com/email-signature/linkedin-36.png"></a></div>
